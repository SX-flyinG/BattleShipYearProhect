...
void Play(int &countOfGames , int& countOfWins) {
    ...
    int countOfMoves = 0;
    int swichSides = 0;
    int countOfShips1 = 31;
    int countOfShips2 = 31;
    ...
    PlaceSubmarine(letterKey, numKey, wayKey, countOfCruiseShip, polePlayer ,  countOfGames,  countOfWins);
    PlaceBattleShip(letterKey, numKey, wayKey, countOfCruiseShip, polePlayer , countOfGames, countOfWins);
    ...
    PlaceSubmarine(letterKey, numKey, wayKey, countOfCruiseShip, polePlayer2 , countOfGames,  countOfWins);
    PlaceBattleShip(letterKey, numKey, wayKey, countOfCruiseShip, polePlayer2 ,  countOfGames, countOfWins);
